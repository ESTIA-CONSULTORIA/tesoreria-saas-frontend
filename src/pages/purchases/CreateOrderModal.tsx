...
export default function CreateOrderModal({ open, onClose, onCreated, suppliers }: Props) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setError(err.response?.data?.message || "No fue posible crear la orden de compra");
    } finally {
      setLoading(false);
    }
  }
      ...
      <div className="w-full max-w-3xl max-h-[90vh] flex flex-col rounded-xl border border-slate-800 bg-slate-900 shadow-2xl overflow-hidden">
        ...
        <div className="flex-shrink-0 p-6 border-b border-slate-800">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-slate-400">Completa los datos de la orden</p>
            </div>
            <button
              onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          <div className="grid gap-4 grid-cols-1 md:grid-cols-2">
            ...
            <div>
              <label className="block text-sm text-slate-400 mb-1">Fecha entrega esperada</label>
              <input
                type="date"
